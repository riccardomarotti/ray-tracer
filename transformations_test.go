...
func TestTranslation(t *testing.T) {
	translation := Identity().Translate(5, -3, 2)
	p := Point(-3, 4, 5)
...
func TestRotatePointAroundXAxis(t *testing.T) {
	...
	halfQuarterRotation := Identity().RotateX(math.Pi / 4)
	quarterRotation := Identity().RotateX(math.Pi / 2)
...
func TestRotatePointAroundYAxis(t *testing.T) {
	...
	halfQuarterRotation := Identity().RotateY(math.Pi / 4)
	quarterRotation := Identity().RotateY(math.Pi / 2)
...
func TestRotatePointAroundZAxis(t *testing.T) {
	...
	halfQuarterRotation := Identity().RotateZ(math.Pi / 4)
	quarterRotation := Identity().RotateZ(math.Pi / 2)
...
func TestShearingXtoY(t *testing.T) {
	shearing := Identity().Shear(1, 0, 0, 0, 0, 0)
	p := Point(2, 3, 4)
...
func TestShearingXtoZ(t *testing.T) {
	shearing := Identity().Shear(0, 1, 0, 0, 0, 0)
	p := Point(2, 3, 4)
...
func TestShearingYtoX(t *testing.T) {
	shearing := Identity().Shear(0, 0, 1, 0, 0, 0)
	p := Point(2, 3, 4)
...
func TestShearingYtoZ(t *testing.T) {
	shearing := Identity().Shear(0, 0, 0, 1, 0, 0)
	p := Point(2, 3, 4)
...
func TestShearingZtoX(t *testing.T) {
	shearing := Identity().Shear(0, 0, 0, 0, 1, 0)
	p := Point(2, 3, 4)
...
func TestShearingZtoY(t *testing.T) {
	shearing := Identity().Shear(0, 0, 0, 0, 0, 1)
	p := Point(2, 3, 4)
...
func TestChainingTransformation(t *testing.T) {
	p := Point(1, 0, 1)
	rotationX := Identity().RotateX(math.Pi / 2)
	scaling := Identity().Scale(5, 5, 5)
	translation := Identity().Translate(10, 5, 7)
